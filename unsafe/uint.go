...
//
// In addition to the uint32 value, returns the number of used bytes and the
// mus.ErrTooSmallByteSlice error.
...
//
// In addition to the uint16 value, returns the number of used bytes and the
// mus.ErrTooSmallByteSlice error.
...
//
// In addition to the uint8 value, returns the number of used bytes and the
// mus.ErrTooSmallByteSlice error.
...
//
// In addition to the uint value, returns the number of used bytes and the
// mus.ErrTooSmallByteSlice error.
