...
func TestRaw(t *testing.T) {
	...
	t.Run("setUpUintFuncs", func(t *testing.T) {
		...
		t.Run("intSize == 32", func(t *testing.T) {
			...
			if !testdata.ComparePtrs(sizeUint, sizeNum32[uint]) {
				t.Error("unexpected sizeUint func")
			}
			if !testdata.ComparePtrs(skipUint, skipInteger32) {
		...
		t.Run("intSize == 64", func(t *testing.T) {
			...
			if !testdata.ComparePtrs(sizeUint, sizeNum64[uint]) {
				t.Error("unexpected sizeUint func")
			}
			if !testdata.ComparePtrs(skipUint, skipInteger64) {
				t.Error("unexpected skipUint func")
			}
		})
	...
	t.Run("setUpIntFuncs", func(t *testing.T) {
		...
		t.Run("intSize == 32", func(t *testing.T) {
			...
			if !testdata.ComparePtrs(sizeInt, sizeNum32[int]) {
				t.Error("unexpected sizeInt func")
			}
			if !testdata.ComparePtrs(skipInt, skipInteger32) {
		...
		t.Run("intSize == 64", func(t *testing.T) {
			...
			if !testdata.ComparePtrs(sizeInt, sizeNum64[int]) {
				t.Error("unexpected sizeInt func")
			}
			if !testdata.ComparePtrs(skipInt, skipInteger64) {
				t.Error("unexpected skipInt func")
			}
		})
