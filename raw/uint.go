...
// MarshalUint64 fills bs with the encoded (Raw) uint64 value.
//
...
// MarshalUint32 fills bs with the encoded (Raw) uint32 value.
//
// Returns the number of used bytes. It will panic if receives too small bs.
...
// MarshalUint16 fills bs with the encoded (Raw) uint16 value.
//
// Returns the number of used bytes. It will panic if receives too small bs.
...
// MarshalUint8 fills bs with the encoded (Raw) uint8 value.
//
// Returns the number of used bytes. It will panic if receives too small bs.
...
// MarshalUint fills bs with the encoded (Raw) uint value.
//
// Returns the number of used bytes. It will panic if receives too small bs.
...
//
// In addition to the uint64 value and the number of used bytes, it can
...
//
// In addition to the uint32 value and the number of used bytes, it can
// return mus.ErrTooSmallByteSlice.
...
//
// In addition to the uint16 value and the number of used bytes, it can
// return mus.ErrTooSmallByteSlice.
...
//
// In addition to the uint8 value and the number of used bytes, it can
// return mus.ErrTooSmallByteSlice.
...
//
// In addition to the uint value and the number of used bytes, it can
// return mus.ErrTooSmallByteSlice.
